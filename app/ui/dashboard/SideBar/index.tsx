...
const Icon = ({ children }: Props) => (
  <svg
    className="w-5 h-5 transition duration-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-zinc-300"
    aria-hidden="true"
...
const dashBoardIcons = [
  ...
  { icon: ConfigIcon, label: 'Compras', link: DASHBOARD_PATH.PURCHASE },
];
